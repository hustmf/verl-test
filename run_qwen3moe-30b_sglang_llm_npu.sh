...
ray start --head --port 6766 --dashboard-host="0.0.0.0"  --node-ip-address=172.27.1.120 --dashboard-port=4919 --resources='{"NPU": '$NPUS_PER_NODE'}'
# Model Weights Paths
...
ACTOR_CONFIG=(
    ...
    actor_rollout_ref.actor.mindspeedllm.engine_kwargs.seq_length=4096
