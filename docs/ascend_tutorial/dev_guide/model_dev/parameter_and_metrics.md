...
如需查看NPU相关特性，请访问：[NPU高级特性指南](https://github.com/verl-project/verl/blob/main/docs/ascend_tutorial/feature_support/npu_advance_features.md)。

verl通过层级化的YAML配置文件管理所有参数，涉及到的所有配置文件均在 `verl/trainer/config` 目录下。
